        ...
        <>
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to upgrade your career OS?</h2>
                    <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto">Join thousands of professionals who have already cloned their potential and secured their dream roles.</p>
                    <button className="group relative inline-flex h-14 items-center justify-center overflow-hidden rounded-lg bg-primary px-8 font-medium text-background-dark transition-all duration-300 hover:w-full hover:max-w-[240px] hover:bg-primary-dark">
                        <span className="mr-2 text-lg font-bold">Initialize Twin</span>
                    ...
                    <p className="mt-6 text-sm text-gray-500">No credit card required for initial analysis.</p>
                </div>
            </section>
            ...
            <footer className="bg-surface-darker border-t border-white/5 py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-400 font-bold">JobTwin © 2023</span>
                    </div>
                    <div className="flex gap-8">
                        ...
                        <a className="text-sm text-gray-500 hover:text-white transition-colors" href="#">Contact Support</a>
                    </div>
